...
declare class BaseComponent {
     ...
     *
     */
    protected static createElement(component: ComponentInterface, parent: HTMLElement, componentInstance: Component, attachToDOM?: boolean): HTMLElement;
    protected $element: HTMLElement;
    protected eventListeners: any;
    protected static componentToString: (componentProps: ComponentInterface) => string;
    protected hasUnAttachedEventListeners: boolean;
    attachEventListener(event: string, listener: Function, override?: boolean, once?: boolean): this;
...
export default class Component extends BaseComponent {
    ...
    bindData(propName: string | number, component: this, componentPropName: string | number, update?: boolean): this;
