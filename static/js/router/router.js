...
import { $, isDev, TextComponent, safeDefine } from "./utils";
...
function _attachEventListener(element, event, listener, bindInstance) {
    element[event] = (e) => {
        console.log(listener);
        return new Function("$", "$event", listener).call(bindInstance, element, e);
    };
}
